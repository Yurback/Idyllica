...
function displayConfirmNotification() {
    ...
    // new Notification('Successfully subscrided', options);
}
...
function configurePushSub() {
    ...
    navigator.serviceWorker
        ...
        .then(function (newSub) {
            return fetch(
                "https://id-y-llica-default-rtdb.europe-west1.firebasedatabase.app/subscriptions.json",
                {
                    method: "POST",
                    headers: {
