...
locationBtn.addEventListener('click', function() {
    ...
    navigator.geolocation.getCurrentPosition(function(position) {
        ...
        locationInput.value = 'In Vladimir';
...
function initializeMedia() {
    ...
    navigator.mediaDevices
        .getUserMedia( confirm('использовать front camera?')? {video:true} : { video: {facingMode:{exact:"environment"}}} )
    ...
    if ("serviceWorker" in navigator && "SyncManager" in window) {
        navigator.serviceWorker.ready.then(function (sw) {
            if ("periodicSync" in sw) {
                console.log("periodicSync is available");
                sw.periodicSync.register("write-log", {
